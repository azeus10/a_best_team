...
ui_interface_number_t *ui_default_shoot_shootup_speed = (ui_interface_number_t *)&(ui_default_shoot_0.data[0]);
ui_interface_number_t *ui_default_shoot_shootleft_speed = (ui_interface_number_t *)&(ui_default_shoot_0.data[1]);
...
void _ui_init_default_shoot_0() {
    ...
    ui_default_shoot_shootup_speed->figure_tpye = 6;
    ui_default_shoot_shootup_speed->layer = 2;
    ui_default_shoot_shootup_speed->font_size = 30;
    ui_default_shoot_shootup_speed->start_x = 286;
    ui_default_shoot_shootup_speed->start_y = 809;
    ui_default_shoot_shootup_speed->color = 0;
    ui_default_shoot_shootup_speed->number = 0;
    ui_default_shoot_shootup_speed->width = 3;

    ui_default_shoot_shootleft_speed->figure_tpye = 6;
    ui_default_shoot_shootleft_speed->layer = 2;
    ui_default_shoot_shootleft_speed->font_size = 30;
    ui_default_shoot_shootleft_speed->start_x = 286;
    ui_default_shoot_shootleft_speed->start_y = 758;
    ui_default_shoot_shootleft_speed->color = 0;
    ui_default_shoot_shootleft_speed->number = 0;
    ui_default_shoot_shootleft_speed->width = 3;
