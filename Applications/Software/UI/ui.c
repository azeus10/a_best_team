...
void ui_supercap(float votage){
  ...
  if(percent<=0)
    percent = 0;
  if(percent >=0.6)
    ui_default_Ungroup_EnergyLine->color = 2;//脗脤脡芦
  if(percent<=0.6)
    ui_default_Ungroup_EnergyLine->color = 3;//鲁脠脡芦
  if(percent <=0.3)
    ui_default_Ungroup_EnergyLine->color = 4;//脳脧潞矛脡芦
...
// void ui_auto(uint8_t status){//脳脭脙茅脠娄脫毛脳脭脙茅驴貌
//    switch (status)//脳脭脙茅脠娄
// 	 {
// 		 case 0:		 
//       ui_default_Ungroup_AutoRound->color=4;//脳脧潞矛脡芦
// 			break;
// 		 case 1:
//       ui_default_Ungroup_AutoRound->color=3;//鲁脠脡芦
// 			break;
// 		 case 2:
//       ui_default_Ungroup_AutoRound->color=2;//脗脤脡芦
// 			break;
// 			default:
//       ui_default_Ungroup_AutoRound->color=4;//脳脧潞矛脡芦
// 			break;			
...
//    if(Global.input.vision_online==0){//脳脭脙茅碌么脧脽
//      ui_default_Ungroup_AutoRound->color=4;//脳脧潞矛脡芦
