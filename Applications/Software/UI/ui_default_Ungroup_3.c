...
ui_interface_string_t* ui_default_Ungroup_Lob = &ui_default_Ungroup_3.option;
...
void _ui_init_default_Ungroup_3() {
    ...
    ui_default_Ungroup_3.option.start_x = 115;
    ui_default_Ungroup_3.option.start_y = 769;
    ui_default_Ungroup_3.option.color = 7;
    ui_default_Ungroup_3.option.str_length = 3;
