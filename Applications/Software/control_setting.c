...
void remove_control_task()
{
  ...
  //左下右中 逆时针陀螺模式
	...
	if(Global.input.ScopeisOpen==0)                            //开瞄准镜 副云台保持水平
	{
		...
		Global.input.Subgimbalisfollow=0;
	}
	else
	{
		gimbal.scope.set=gimbal.scope.offset+10000.0f;
		Global.input.Subgimbalisfollow=1; 
	}
	/****************************RC操作*************************************************/
...
//	if(RC_data.mouse.press_l)
//	{
//		if(Get_sys_time_ms()-Time_delay_tick_left>300)
//		{
//		  Global.input.shoot_fire = RC_data.mouse.press_l;
//			Time_delay_tick_left=Get_sys_time_ms();
//		}
//	}
//	else if(RC_data.mouse.press_l&&Global.input.isHeatLimit==1)
//	{
//		Global.input.shoot_fire=RC_data.mouse.press_l;
//	}
