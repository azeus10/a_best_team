...
//	
//		if (IMU_data.AHRS.last_yaw >2.5)
//		{
//				IMU_data.AHRS.yaw -= 2.54;
//		}
//		if(IMU_data.AHRS.last_yaw <-2.5)
//		{
//				IMU_data.AHRS.yaw += 2.54;		
...
//	IMU_data.gyro[2] -= IMU_data.calibration[2];
	IMU_data.gyro[0] -= 0.001462;
	IMU_data.gyro[1] -= -0.0005318;
	IMU_data.gyro[2] -= -0.000036;
	...
	IMU_data.AHRS.err_code = AHRS_update(IMU_data.AHRS.q, (float)(Get_sys_time_ms() - last_time) * 0.0001,
										 IMU_data.gyro,
										 IMU_data.accel,
										 IMU_data.mag);
